...
int main()
{
    ...
    vec1.dimension = vec2.dimension = vec3.dimension = 3;
    vec1.cords = (double*)malloc(sizeof(double) * vec1.dimension);
    if (vec1.cords == NULL)
    {
    ...
    vec2.cords = (double*)malloc(sizeof(double) * vec2.dimension);
    if (vec2.cords == NULL)
    {
        printf("failed to allocate memory\n");
        return BAD_ALOC;
    ...
    vec3.cords = (double*)malloc(sizeof(double) * vec3.dimension);
    if (vec3.cords == NULL)
    {
        printf("failed to allocate memory\n");
        return BAD_ALOC;
